    ...
    return (
        ...
        `}>
            ...
            <div className="flex gap-5">
                ...
                <Filho nome="Ricardo" sobrenome={props.sobrenome} />
                <Filho nome="Fabio" sobrenome={props.sobrenome} />
                <Filho nome="Rubens" sobrenome={props.sobrenome} />
                <Filho nome="Henrique" sobrenome={props.sobrenome} />
            </div>
        </div>
    )
}